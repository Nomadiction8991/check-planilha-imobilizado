...
class StoreLegacyProductRequest extends FormRequest
{
    ...
    public function toDto(): CreateLegacyProductData
    {
        ...
        return new CreateLegacyProductData(
            ...
            brand: $this->filled('marca') ? trim((string) $this->validated('marca')) : null,
            heightMeters: $this->filled('altura_m') ? (string) $this->validated('altura_m') : null,
            widthMeters: $this->filled('largura_m') ? (string) $this->validated('largura_m') : null,
            lengthMeters: $this->filled('comprimento_m') ? (string) $this->validated('comprimento_m') : null,
