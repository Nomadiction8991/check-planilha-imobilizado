...
class ComumController extends BaseController
{
    ...
    {
        // Variáveis extraídas explicitamente para o arquivo legado
    ...
    public function deleteProducts(): void
    {
        ...
        $comumId = (int) $this->post('comum_id', 0);
        if ($comumId <= 0) {
    ...
    public function update(): void
    {
        ...
        try {
            ...
            $dados = [
                ...
                'cnpj' => trim($this->post('cnpj', '')),
                'administracao' => trim($this->post('administracao', '')),
