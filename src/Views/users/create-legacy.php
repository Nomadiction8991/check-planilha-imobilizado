...
<?php if (!empty($mensagem)): ?>
    <div class="bg-<?php echo $tipo_mensagem === 'success' ? 'green' : 'red'; ?>-50 border border-<?php echo $tipo_mensagem === 'success' ? 'green' : 'red'; ?>-200 rounded-lg p-4 mb-4 flex justify-between items-center">
        <span class="text-<?php echo $tipo_mensagem === 'success' ? 'green' : 'red'; ?>-800"><?php echo to_uppercase(\voku\helper\UTF8::fix_utf8(htmlspecialchars($mensagem, ENT_QUOTES, 'UTF-8'))); ?></span>
        <button type="button" class="text-<?php echo $tipo_mensagem === 'success' ? 'green' : 'red'; ?>-600 hover:text-<?php echo $tipo_mensagem === 'success' ? 'green' : 'red'; ?>-900" onclick="this.parentElement.style.display='none';"><i class="bi bi-x"></i></button>
    </div>
<?php endif; ?>
...
<form method="POST" id="formUsuario">
    ...
    <div class="bg-white rounded-lg shadow-sm border border-slate-200 mb-4">
        <div class="bg-slate-50 px-6 py-3 border-b border-slate-200 flex items-center gap-2">
            ...
            <span class="font-semibold text-slate-700">DADOS BÁSICOS</span>
        </div>
    ...
    <div class="bg-white rounded-lg shadow-sm border border-slate-200 mb-4">
        <div class="bg-slate-50 px-6 py-3 border-b border-slate-200 flex items-center gap-2">
            <i class="bi bi-person-hearts text-slate-600"></i>
            <span class="font-semibold text-slate-700">ESTADO CIVIL</span>
        </div>
        <div class="p-6">
    ...
    <div id="cardConjuge" class="bg-white rounded-lg shadow-sm border border-slate-200 mb-4 hidden">
        <div class="bg-slate-50 px-6 py-3 border-b border-slate-200 flex items-center gap-2">
            <i class="bi bi-people-fill text-slate-600"></i>
            <span class="font-semibold text-slate-700">DADOS DO CÔNJUGE</span>
        </div>
        <div class="p-6 space-y-4">
            <div class="mb-3">
