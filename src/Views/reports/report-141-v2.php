...
<?php if (count($PRODUTOS) > 0): ?>
    ...
    <div class="p-4 bg-neutral-50 border-b border-neutral-200">
        <h6 class="text-sm font-bold text-neutral-700 mb-4 flex items-center gap-2">
            <i class="bi bi-ui-checks"></i> Valores Comuns para Todos (<?php echo count($PRODUTOS); ?> páginas)
        </h6>
        ...
        <?php foreach ($PRODUTOS as $index => $row): ?>
            <div class="bg-white overflow-hidden" style="border-radius:2px">
                <div class="flex items-center justify-between p-4 border-b border-neutral-200">
                    ...
                    <span class="text-xs text-neutral-500 line-clamp-1"><?php echo htmlspecialchars($row['descricao_completa']); ?></span>
                </div>
...
<?php else: ?>
    <div class="m-4 md:m-6 p-4 bg-yellow-50 border border-yellow-300 rounded-lg text-yellow-800">
...
<script src="/assets/js/reports/report-141-v2.js"></script>
