...
?>
    ...
    <div class="max-w-4xl mx-auto bg-white p-0 page-break" style="border-radius:2px">
        <!-- CABEÇALHO -->
        <section class="border-b border-neutral-300 p-4 md:p-6 bg-neutral-50">
            <table>
                <tr class="row1">
        ...
        <section class="p-4 md:p-6">
            <h1 class="text-xl font-bold text-center mb-6 text-neutral-800">TERMO DE RESPONSABILIDADE E CONTROLE DE BENS PATRIMONIAIS</h1>
        ...
        <!-- RODAPÉ -->
        <section class="border-t border-neutral-300 p-4 md:p-6 bg-neutral-50 text-xs text-neutral-600">
            <table>
                <tr class="row1">
                    <td class="col1"></td>
