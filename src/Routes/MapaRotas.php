...
class MapaRotas
{
    public static function obter(): array
    {
        return [
            ...
            'GET /churches/products-count' => [ComumController::class, 'productsCount'],
            ...
            'POST /products/clear-edits' => [ProdutoController::class, 'clearEdits'],
            ...
            'GET /spreadsheets/api/progress' => [PlanilhaController::class, 'progressoImportacao'],
