        ...
        <div class="filters" data-sticky-filters>
            <form method="GET" action="{{ route('migration.labels.index') }}">
                <div class="filters-primary">
                    <label for="labels-admin-search">
                        ...
                        <input
                            id="labels-admin-search"
                            type="search"
                            placeholder="Digite para filtrar"
                            autocomplete="off"
                            aria-controls="labels-admin-select"
                            data-labels-admin-search
                        >
                    </label>
            ...
            <script>
                (() => {
                    ...
                    const adminSelect = document.querySelector('[data-labels-admin-select]');
                    const adminStatus = document.querySelector('[data-labels-admin-status]');
