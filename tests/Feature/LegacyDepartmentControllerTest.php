...
final class LegacyDepartmentControllerTest extends TestCase
{
    ...
    public function testIndexPageRendersPaginatedList(): void
    {
        ...
        self::assertMatchesRegularExpression('/<select[^>]+name="comum_id"[^>]+data-filter-server/', $html);
        ...
        self::assertStringNotContainsString('data-departments-admin-search data-filter-search', $html);
        self::assertStringNotContainsString('data-departments-church-search data-filter-search', $html);
    }
