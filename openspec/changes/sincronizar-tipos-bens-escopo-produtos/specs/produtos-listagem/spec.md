...
- **GIVEN** um usuário restrito com uma administração ativa e outras administrações permitidas
- **WHEN** o sistema carrega os tipos de bem para a listagem ou cadastro de produtos
- **THEN** são exibidos tipos das administrações permitidas e tipos compartilhados sem administração
- **AND** tipos vinculados a administrações não permitidas não são exibidos
