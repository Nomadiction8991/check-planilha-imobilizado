...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const updateActionButtons = (row, state) => {
        ...
        row.querySelectorAll('.action-observacao').forEach(el => {
            el.style.display = 'inline-block';
        ...
        row.querySelectorAll('.action-editar').forEach(el => {
            el.style.display = 'inline-block';
...
function startFullscreenScanner() {
    ...
    Quagga.onDetected(function(result) {
        ...
        const codigoInput = document.getElementById('codigo')
            || document.getElementById('filtro_codigo')
            || document.querySelector('input[name="codigo"]')
            || document.querySelector('input[name="filtro_codigo"]');
        if (codigoInput) {
