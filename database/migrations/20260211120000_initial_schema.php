...
CREATE TABLE `produtos` (
  ...
  `tipo_bem_id` int NOT NULL DEFAULT 99,
  `bem` text NOT NULL,
  `complemento` text DEFAULT NULL,
  `dependencia_id` int NOT NULL DEFAULT 0,
  `editado_tipo_bem_id` int DEFAULT NULL,
  `editado_bem` varchar(255) DEFAULT NULL,
  `editado_complemento` varchar(255) DEFAULT NULL,
  `editado_dependencia_id` int DEFAULT NULL,
  `novo` int NOT NULL DEFAULT 0,
  `importado` tinyint(1) NOT NULL DEFAULT 0,
  `checado` int NOT NULL DEFAULT 0,
  `editado` int NOT NULL DEFAULT 0,
  `imprimir_etiqueta` int NOT NULL DEFAULT 0,
  `imprimir_14_1` int NOT NULL DEFAULT 0,
...
SQL);
    ...
    {
        DB::statement('DROP TABLE IF EXISTS import_erros');
        DB::statement('DROP TABLE IF EXISTS importacoes');
        DB::statement('DROP TABLE IF EXISTS import_job_processed');
        DB::statement('DROP TABLE IF EXISTS produtos');
        DB::statement('DROP TABLE IF EXISTS usuarios');
        DB::statement('DROP TABLE IF EXISTS tipos_bens');
        DB::statement('DROP TABLE IF EXISTS dependencias');
        DB::statement('DROP TABLE IF EXISTS configuracoes');
        DB::statement('DROP TABLE IF EXISTS comums');
    }
};
